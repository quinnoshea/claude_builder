...
class TestTemplateCommands:
    ...
    def test_install_template_command(self, mock_template_manager_class):
        ...
        result = runner.invoke(templates, ["install", "community/django-rest"], input="y\n")
        assert result.exit_code == 0
    ...
    def test_install_template_command_force(self, mock_template_manager_class):
        ...
        mock_result = Mock()
        mock_result.is_valid = True
        mock_result.suggestions = ["Template installed successfully with force overwrite"]
        mock_result.errors = []
    ...
    def test_validate_template_with_warnings_only(self, mock_template_manager_class):
        ...
        mock_result.is_valid = True
        mock_result.errors = []
        mock_result.warnings = ["Deprecated syntax used", "Consider updating variable names"]
        mock_result.suggestions = []
