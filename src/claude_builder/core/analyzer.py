...
from .models import (
    ...
    DevelopmentEnvironment, FileSystemInfo, ProjectType,
    ComplexityLevel, ArchitecturePattern
)
from ..utils.file_patterns import FilePatterns
...
class ProjectAnalyzer:
    ...
    def _determine_project_type(
        ...
        cli_indicators = [
            # File indicators
            any('main.py' == f for f in filesystem_info.root_files),
