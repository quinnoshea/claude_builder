...
from .models import ProjectAnalysis, LanguageInfo, FrameworkInfo, ProjectType, ComplexityLevel
    ...
    def _create_custom_agent(self, pattern: str, analysis: ProjectAnalysis) -> Optional[AgentInfo]:
        ...
        custom_templates = {
            ...
            'automation_specialist': {
                'description': f'Build and deployment automation specialist',
                'use_cases': ['build scripts', 'deployment automation', 'workflow optimization']
            },
            'container_specialist': {
                'description': f'Container orchestration and deployment specialist',
