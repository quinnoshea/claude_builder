...
class ClaudeBuilderError(Exception):
    ...
    def __init__(self, message: str, exit_code: int = 1, context=None, cause=None, suggestions=None, **kwargs):
...
class GenerationError(ClaudeBuilderError):
    ...
    def __init__(self, message: str, template_name=None, output_path=None, **kwargs):
        super().__init__(message, exit_code=6, template_name=template_name, output_path=output_path, **kwargs)
...
class ConfigError(ClaudeBuilderError):
    ...
    def __init__(self, message: str, config_file=None, config_section=None, **kwargs):
        super().__init__(message, exit_code=10, config_file=config_file, config_section=config_section, **kwargs)
